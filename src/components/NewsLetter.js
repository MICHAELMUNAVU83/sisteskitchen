    ...
    <div id="contact" className="my-12">
      <div className="bg-gradient-to-tl rounded-3xl from-[#A0D9C1] flex md:flex-row flex-col justify-between my-auto mx-auto  md:h-[82vh] overflow-hidden w-[90%]   md:w-[80%]">
        <div className="flex mt-24 flex-col gap-2 p-4 md:p-8 md:pl-16">
          <h1 className="md:text-5xl text-3xl font-bold">Subscribe to Our</h1>
          <h1 className="md:text-5xl text-2xl w-[100%] text-leading font-bold">
          ...
          <div className="text-xl flex flex-col gap-2 ">
            ...
            <div className="flex text-sm md:text-md text-gray-500 hover:text-black hover:scale-105 transition-all duration-300  items-center">
              <a
            ...
            <div className="flex text-sm md:text-md text-gray-500 hover:text-black hover:scale-105 transition-all duration-300  items-center">
              <a href="/" className="flex items-center">
                <IoLocationSharp className="mx-2" /> Hanton Towers, Thika Kenya
              </a>
            </div>
          </div>
        </div>
