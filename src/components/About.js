    ...
    >
      ...
      <div className="flex md:p-0 p-4 flex-col gap-2 md:gap-8">
        ...
        <p className="md:w-[600px] quicksand  text-gray-400">
          I make amazing food ranging from African to American and everything in
          between. I have been cooking for over 10 years and I love to share my
          passion with others.
        </p>
        <p className="md:w-[600px] quicksand text-gray-400">
          I have services ranging from meal prep, in house and outdoor catering
          and cooking classes. I am also available for private events and
          parties.
        </p>
